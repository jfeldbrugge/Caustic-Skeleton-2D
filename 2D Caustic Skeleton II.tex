...
\title{Caustic Skeleton \& Cosmic Web: non-linear Constrained Realizations -- 2D case studies}
...
For the constrained realizations in and around the swallowtail cluster caustic we invoke the caustic conditions concerning the field of the largest eigenvalue $\lambda_1$, 
\begin{align}
b_+(t) \lambda_1(\bm{q}_c) = 1\,,\\
