...
\abstract{
\noindent 
The comic web is the largest structural of our universe, consisting of a complex interplay between voids, walls, filaments and clusters, forming under to the gravitational collapse of Gaussian fluctuations. These simple Gaussian initial conditions are directly related to the intricate current cosmic web by the caustic structure of the dynamically evolving mass distribution. The caustic skeleton traces the evolution of these caustics structures forming the dynamical skeleton of the cosmic web. In this paper, we extent constrained Gaussian random field theory to non-linear constraints, to evaluate the properties of the Gaussian initial conditions in the vicinity of the different elements of the two-dimensional caustic skeleton. The combination of non-linear constrained theory and caustic skeleton theory, forms a new framework for the study of the formation histories of the different walls, filaments and clusters of the large-scale structure and their geometric and topological properties, putting flesh on the bones of the cosmic skeleton.
...
emerging structure. However, even while several up-to-date projects provide suites consisting of a large number of simulations that offer a good representation of many aspects of the structure formation process \citep{ABACUSSUMMIT:2021, Quijote:2020}, they are usually too expensive and do not possess the flexibility to infer the required information on all relevant cosmological and structure formation aspects. As purely numerical simulations are very expensive, it is likely that numerical methods in combination based on a foundation of analytical descriptions of the structure formation process lead to a considerably more versatile formalism for inferring the requested information on the underlying physical and cosmological processes. Perhaps even more important is that proper relevant analytical descriptions lead to a substantial 
