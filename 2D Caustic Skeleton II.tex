...
The study of the cosmic web has a remarkable correspondence to statistical field theory for the study of phase transition in thermodynamics. Both theories describe the emergent behaviour of a large number of particles described by a Euclidean path integral \cite{Feynman:1965}. Whereas the path integral in statistical field theory emerges from the from the thermal fluctuations of an ensemble of particles, the integral for late time cosmology results from the statistical properties the density fluctuations at the time of re-combination as observed in the surface of last scattering, whose imprint can be observed in the cosmic microwave background radiation field. In statistical field theory, the use of path integrals, and the corresonding techniques such as mean field theory, has been very successful at tracing universal features of thermodynamic systems, predicting the critical exponents. We are hopeful that these well-established techniques will be also beneficial to the systematic and analytic exploration of the properties of the intricate cosmic web.
