...
that offer a good representation of many aspects of the structure formation process \citep{Abacussummit,Quijote}, they are usually
  ...
  structure formation aspects. As purely numerical simulations are very expensive, it is likely that numerical methods in
  combination based on a foundation of analytical descriptions of the structure formation process lead to a considerably
  more versatile formalism for inferring the requested information on the underlying physical and cosmological processes.
...
\end{subfigure}\\ \vspace{-0.5\baselineskip}
%%%%%%%%%%
%%%%%%%%%%
\begin{subfigure}[b]{0.31\textwidth}
...
\end{subfigure}
\caption{Elements of the caustic skeleton consisting of the fold curves (red) and cusp curve (blue) in Lagrangian and Eulerian space.. \textit{From top to bottom:} the cusp, the swallowtail, the elliptic and the hyperbolic caustic. \textit{Left:} the caustic skeleton in Lagrangian space. \textit{Centre:} the Zel'dovich approximation. \textit{Right:} the corresponding $N$-body simulation \cite{Hidding:2020}.}\label{fig:caustics_Examples_Big}
\end{figure}
