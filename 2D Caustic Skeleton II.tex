...
For small $q_1$ and $q_2$, the level set $\det \nabla \bm{x}_t =0$ approaches a conic section; an ellipse when the discriminant $B^2 - 4AC$ is negative corresponding to the $D_4^+$ caustic, a hyperbole when the discriminant $B^2 - 4AC$ is positive corresponding to the $D_4^-$ caustic, and a parabola when the discriminant $B^2 - 4AC$ vanishes, corresponding to the $D_5$ caustic (which does not feature in the 2D cosmic web). Note that the discriminant coincides wit the negative of the determinant of the Hessian, \textit{i.e.},
\begin{align}
